...
## Group the data and do further analysis
```{r}
...
```{r}
# Scatter plot of n_trials vs. success_rate
ggplot(meta, aes(x = n_brain_area, y = n_neurons)) +
  geom_point(color = "steelblue") +
  labs(title = "Number of Brain Areas vs. Number of Neurons",
       x = "Number of Brain Areas",
       y = "Number of Neurons")
...
```{r}
# Scatter plot of n_trials vs. success_rate
ggplot(meta, aes(x = n_trials, y = success_rate)) +
  geom_point(color = "steelblue") +
  labs(title = "Number of Trials vs. Success Rate",
       x = "Number of Trials",
       y = "Success Rate")
...
```{r}
# Convert date_exp to Date format
meta$date_exp <- as.Date(meta$date_exp)

# Line plot of success rate over time
ggplot(meta, aes(x = date_exp, y = success_rate)) +
...
```{r}
# Grouped bar plot of brain areas and success rate
ggplot(meta, aes(x = n_brain_area, fill = success_rate)) +
  geom_bar(position = "dodge") +
  labs(title = "Brain Areas and Success Rate",
       x = "Number of Brain Areas",
       y = "Count",
       fill = "Success Rate")
```
